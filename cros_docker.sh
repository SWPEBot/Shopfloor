...
RESOURCE_DOCKER_SHA1="b0b89899fffb0397beeb71352dabf429372e7eb9"
...
DOCKER_IMAGE_GITHASH="a86d115806ff7340c7891c141b1f540f89aaf8f4"
DOCKER_IMAGE_TIMESTAMP="20250729110140"
...
do_umpire_run() {
  ...
  # Sync following code with py/dome/backend/models.py CreateUmpireContainer.
  ...
  local umpire_grpc_port=$((umpire_base_port + 9))
