...
TRACE_DIR="/home/sysadmin/SN_TRACE"
MODEL_TRACE_NAME="ZCQ"
LOG_SUFFIX=".csv"
WL_SN_LOG_PATH=os.path.join(TRACE_DIR,MODEL_TRACE_NAME+LOG_SUFFIX)
DEFAULT_SERVER_PORT = 13430
