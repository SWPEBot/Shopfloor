...
class HTTPShopfloorBackend(object):
    ...
    def MappingDeviceData(self, data):
        ...
        if isinstance(message_dict, dict):
            ...
            if whitelabel_tag == "Packardbell":
                response['vpd.ro.whitelabel_tag'] = "magneto_pb"
            if whitelabel_tag == "none":
               del response['vpd.ro.whitelabel_tag']
