...
# ZCG (Craasneto)   use the port
DEFAULT_SERVER_PORT = 12950
...
# REGCODE_LOG_CSV = '/home/sysadmin/RegistrationCode/ZCG/Craasneto_registration_code_log.csv'
...
class ShopfloorService(object):
    ...
    def ActivateRegCode(self, ubind_attribute, gbind_attribute, hwid):
        ...
        if hwid in [None, 'NA']:  # for smt spare part
            board = 'CRAASNETO'
        else:
