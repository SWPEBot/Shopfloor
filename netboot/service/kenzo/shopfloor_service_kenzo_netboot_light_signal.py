...
REGCODE_LOG_CSV = '/home/sysadmin/RegistrationCode/ZDFB/registration_code_log.csv'
...
class QuantaShopfloor(object):
    ...
    def __init__(self):
        ...
        self.translate_response = {
            ...
            'ISTOUCH ': 'component.has_touchscreen',
    ...
    def TranslateTouchscreen(self, data):
        """For Some Projuect Translate touchscreen args."""
        key_is_touch = 'component.has_touchscreen'
        value_is_touch = data.get(key_is_touch, '')
        if value_is_touch == 'Y':
            data[key_is_touch] = True
        else:
            data[key_is_touch] = False
        return data
    ...
    def TranslateResponse(self, response):
        ...
        if 'component.has_touchscreen' in data:
            data = self.TranslateTouchscreen(data)
        return data
