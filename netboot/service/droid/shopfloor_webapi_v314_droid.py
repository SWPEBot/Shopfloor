...
class HTTPShopfloorBackend(object):
    ...
    def MappingDeviceData(self, data):
        ...
        if isinstance(message_dict, dict):
            ...
            whitelabel_tag = response.get("vpd.ro.whitelabel_tag")
            ...
            if whitelabel_tag == "ZBCD":
                response['vpd.ro.whitelabel_tag'] = "droid-pd"
            if whitelabel_tag == "ZBCB":
                response['vpd.ro.whitelabel_tag'] = "droid-pd"
