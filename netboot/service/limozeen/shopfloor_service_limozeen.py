...
REGCODE_LOG_CSV = '/home/sysadmin/RegistrationCode/ZC9/Limozeen_registration_code_log.csv'
...
class QuantaShopfloor(object):
  ...
  def SMT_END(self, data):
    IMEI = data['factory.SIMIMEI'].strip('Limozeen')
    LTE_EID = data['factory.LTE_EID'].strip('Limozeen')
    extra_data = {'STATION': 'FVS',
                  'onboard_wifi': 'true',
