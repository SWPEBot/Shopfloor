...
BASE_PATH2 = '/mnt/66'
BASE_PATH3 = '/mnt/77'
BASEFILE_ZCCA = 'omahaserver_lalala.conf'
USERNAME = 'A0044319'
...
class balance(threading.Thread):
    ...
    def run(self):
        ...
        while not self.thread_stop:
            while not os.path.exists(os.path.join(BASE_PATH1, BASEFILE_ZCCA)):
                CheckConf11()

            while not os.path.exists(os.path.join(BASE_PATH2, BASEFILE_ZCCA)):
                CheckConf12()

            while not os.path.exists(os.path.join(BASE_PATH3, BASEFILE_ZCCA)):
                CheckConf13()
...
if __name__ == '__main__':
    ...
    thread1 = balance('ZCCA', BASEFILE_ZCCA, INI_ZCCA)
    thread1.start()
