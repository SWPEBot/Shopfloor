...
BASE_PATH2 = '/mnt/66'
BASE_PATH3 = '/mnt/77'
BASEFILE_ZBL = 'omahaserver_ezkinil.conf'
USERNAME = 'A0044319'
...
class balance(threading.Thread):
    ...
    def run(self):
        ...
        while not self.thread_stop:
            while not os.path.exists(os.path.join(BASE_PATH1, BASEFILE_ZBL)):
                CheckConf11()

            while not os.path.exists(os.path.join(BASE_PATH2, BASEFILE_ZBL)):
                CheckConf12()

            while not os.path.exists(os.path.join(BASE_PATH3, BASEFILE_ZBL)):
                CheckConf13()
...
if __name__ == '__main__':
    ...
    thread1 = balance('ZBL', BASEFILE_ZBL, INI_ZBL)
    thread1.start()
