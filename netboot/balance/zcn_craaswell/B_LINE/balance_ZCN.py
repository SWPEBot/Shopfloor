...
class balance(threading.Thread):
    ...
    def run(self):
        ...
        while not self.thread_stop:
            while not os.path.exists(os.path.join(BASE_PATH1, BASEFILE_ZCN)):
                CheckConf11()

            while not os.path.exists(os.path.join(BASE_PATH2, BASEFILE_ZCN)):
                CheckConf12()

            while not os.path.exists(os.path.join(BASE_PATH3, BASEFILE_ZCN)):
                CheckConf13()

            while not os.path.exists(os.path.join(BASE_PATH4, BASEFILE_ZCN)):
                CheckConf14()
...
if __name__ == '__main__':
    ...
    thread1 = balance('ZCN', BASEFILE_ZCN, INI_ZCN)
    thread1.start()
